                    ...
                    <FormItem className='grid gap-3'>
                      ...
                      <FormControl>
                        ...
                        >
                          ...
                          hover:text-foreground has-checked:bg-secondary has-checked:text-secondary-foreground'
                          >
                            <RadioGroupItem
                              value='user'
                              className='sr-only'
                          ...
                          <Label
                            className='h-[34px] w-full grid place-items-center rounded-e-sm text-muted-foreground hover:text-forground 

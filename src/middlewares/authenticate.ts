 ...
 *              If the token is valid, the user's ID is attached to thr request object.
 ...
 * @param { REsponse} res - Express response onject used to send error responses if authentication fails.
...
const authenticate = async (
  ...
  //If there's no Bearer token, responds with 401 Unauthorized
  ...
  try {
    ...
    //Attach the userId to the request object for later used
